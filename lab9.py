    ...
    with open(ifname, 'r', encoding='utf-8') as reader, open(ofname, 'w', encoding='utf-8') as writer:
        ...
        while True:
            try:
                ...
                fmt_s = f'f(x)={func_name}, [a, b] = [{a}, {b}], точное значение: {real_int_val}'
                print(fmt_s, file=writer)
                ...
                if method_type == '--direct':
                    while True:
                        ...
                        for h in h_list:
                            ...
                            fmt_s = f'\th: {h}  ->  интеграл: {int_val},  (I - I_n): {real_err:.2e}'
                            print(fmt_s, file=writer)
                        print(file=writer)
                ...
                # с автоматическим выбором шага
                    ...
                    while True:
                        ...
                        for err in err_list:
                            ...
                            fmt_s = f'\tпогрешность: {err}  ->  h: {h},  число шагов: {amount},'
                            fmt_s += f'\t\tинтеграл: {int_val},  (I - I_n): {real_err:.2e}'
                            print(fmt_s, file=writer)
                        print(file=writer)
                else:
